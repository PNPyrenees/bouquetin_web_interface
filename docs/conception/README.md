...
- `maquette_01_interface_principale.png` - Interface principale : carte, filtres gauche, trajectoire GPS avec gradient, header double bande

- `maquette_02_panneau_donnees.png` - Panneau attributaire onglet Données : tableau avec 9 colonnes (Individu, Population, Date/Heure locale, Altitude, Température, DOP, Nb satellites, Pos. aberrante, Constructeur)
